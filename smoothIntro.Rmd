...
The following group of plots shows three different modifications of the original opioid mortality data. An additional plot was added here where the top two opioid mortality rates were replaced with NA values to help reduce the color range in the map, making other high mortality rates easier to identify.
Before moving on to other methods, it may be useful to ask around the department and do some reading about the opioid outcomes in these regions to confirm that these maps are demonstrating realistic patterns.
